...
class Routes {
  ...
  static const selectRegionView = '/select-region-view';
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      Routes.selectRegionView,
      page: _i9.SelectRegionView,
    ),
  ];
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i9.SelectRegionView: (data) {
      return _i1.buildAdaptivePageRoute<dynamic>(
        builder: (context) => const _i9.SelectRegionView(),
        settings: data,
      );
    },
  };
...
extension NavigatorStateExtension on _i11.NavigationService {
  ...
  Future<dynamic> navigateToSelectRegionView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.selectRegionView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
